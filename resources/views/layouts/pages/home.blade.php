                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="title-area">
                        <div class="sec-icon"><img src="assets/img/icon/sec-icon.png" alt="Section Title"></div><span
                            class="sub-title">Welcome to Allure Makeup Studio</span>
                        <h2 class="sec-title">Experience Luxury Makeup For Every Occasion Where You Want to Shine.</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="about-media-wrap">
                        <div class="d-md-flex gap-4 about-media text-center text-md-start">
                            ...
                            <div class="media-body">
                                <h4 class="fw-semibold mb-1 mt-n1">Flawless Bridal Makeup for Your Special Day</h4>
                                <p>Experience expert makeup artistry that enhances your natural beauty, leaving you radiant,
                                    confident, and unforgettable on your wedding day.</p>
                            </div>
                        </div>
                        <div class="d-md-flex gap-4 about-media text-center text-md-start">
                            ...
                            <div class="media-body">
                                <h4 class="fw-semibold mb-1 mt-n1">Glamorous Makeup for Every Occasion</h4>
                                <p>Turn heads at any event with personalized makeup looks designed to highlight your
                                    features and
                        ...
                        <div class="d-md-flex gap-4 about-media text-center text-md-start">
                            ...
                            <div class="media-body">
                                <h4 class="fw-semibold mb-1 mt-n1">Luxury Makeup That Speaks for You</h4>
                                <p>Professional makeup services crafted to make you shine effortlessly, whether for
                                    photoshoots,
                                    parties, or special celebrations.</p>
                            </div>
                        </div>
                    </div>
                </div>
