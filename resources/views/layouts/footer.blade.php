<footer class="footer-wrapper footer-layout2 bg-dark" data-bg-src="assets/img/bg/bg-fooer-2-1.jpg">
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-12">
                <div class="footer-logo mb-3 mb-xl-5"><a href="index.html"><img src="assets/img/logo-mix.png"
                            alt="Haarino"></a></div>
            </div>
            ...
            <div class="col-12">
                ...
                <p class="text-white fw-medium mb-0">Copyright <i class="fal fa-copyright"></i> 2022 <a
                        class="text-white" href="index.html">Haarino</a> - All rights reserved by <a class="text-white"
